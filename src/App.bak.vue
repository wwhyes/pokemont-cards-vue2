<template>
  <main>
    <header>
      ...
      <div v-if="cards[23]" class="showcase">
        <Card
    ...
    <CardList>
      <template v-for="(card, id) in basics">
        <Card
          :key="id"
    ...
    <CardList>
      <template v-for="(card, id) in holos">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in galaxies">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in radiant">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in basicGallery">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in veeUltra">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in veeAlt">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in veeMax">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in veeMaxAlt">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in veeStar">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in trainerHolo">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in rainbow">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in gold">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
    ...
    <CardList>
      <template v-for="(card, id) in veeGallery">
        <Card
          :key="id"
          :img="card.images.large"
          :number="card.number"
...
export default {
  ...
  methods: {
    async getCards () {
      ...
      this.cards = cards
      this.basics = cards.slice(0, 6)
      this.holos = cards.slice(6, 12)
      this.galaxies = cards.slice(12, 15)
      this.radiant = cards.slice(15, 18)
      this.basicGallery = cards.slice(60, 63)
      this.vee = cards.slice(18, 21)
      this.veeUltra = cards.slice(21, 24)
      this.veeAlt = [...cards.slice(27, 30), ...cards.slice(33, 36)]
      this.veeMax = cards.slice(24, 27)
      this.veeMaxAlt = [cards[36], cards[31], cards[37]]
      this.veeStar = cards.slice(39, 42)
      this.trainerHolo = cards.slice(42, 48)
      this.rainbow = cards.slice(48, 51)
      this.gold = cards.slice(51, 60)
      this.veeGallery = cards.slice(63, 69)
    }
  },
  mounted () {
    this.getCards()
